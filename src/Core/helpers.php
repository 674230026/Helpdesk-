...
if (!function_exists('svg_icon')) {
    /**
     * Render crisp enterprise SVG vector icons (Heroicons / Lucide style)
     */
    function svg_icon(string $name, string $classes = 'w-5 h-5'): string
    {
        $icons = [
            ...
            'truck' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8h4.586a1 1 0 01.707.293l2.414 2.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h2"/>',
        ...
        $path = $icons[$name] ?? $icons['ticket'];
        $safeClasses = htmlspecialchars($classes, ENT_QUOTES, 'UTF-8');

        return '<svg class="' . $safeClasses . '" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">' . $path . '</svg>';
    }
}
